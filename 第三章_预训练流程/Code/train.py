...
if __name__ == "__main__":
    ...
    # ------------------- 基础训练参数 -------------------
    parser.add_argument("--out_dir", type=str, default="../ModelZoom/base-CodeLab-50M", help="模型输出目录")
    ...
    parser.add_argument("--data_path", type=str,
                        default="/root/autodl-tmp/Dataset/seq_monkey_datawhale.jsonl",
                        help="训练数据路径")
    ...
    if args.use_swanlab and args.local_rank == 0:
        ...
        swanlab.init(project="CodeLab-LLM", experiment_name="Pretrain-50M", config=args)
